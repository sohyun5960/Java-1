...
public class Ex04_Array {
	...
	public static void main(String[] args) {
		...
		char[] ch1 = {'훈','짱'}; //char : 문자 타입(한글자)
		String[] str1 = {"인덱스0","인덱스1","인덱스2"}; //String : 문자열 타입(여러글자)
		
		System.out.println("String 타입 str1에서 2번째 집에 저장된 값은 : ");
		...
		// for문을 이용해서 num3 배열에 저장 된 값을 모두 출력
		// i=0, length 사용
		...
		System.out.println("number[] 총점 : " + sum);
		System.out.println("number[] 평균 : " + avg);
